...
# ------------------------------------- Preprocessing Training and User Data -------------------------------------------
    ...
    for user_id in range(main.USER_PREDICTION_MIN_ID, main.USER_PREDICTION_MAX_ID):
        filtered_user_data_dictionary = {}  # {"movie id" : "movie rating", ...}

        # Gather rating information about user
        for user_data in main.USER_DATA_DICTIONARY[user_id]:
            if user_data[1] != 0:
        ...
        for training_data_id in range(0, 200):
            ...
            for movie_id in filtered_user_data_dictionary:
                training_rating = main.TRAINING_DATA_MATRIX[training_data_id][movie_id-1]
            ...
            if len(mutually_rated_movies) == 0:
                ...
                training_rating = main.TRAINING_DATA_MATRIX[training_data_id][mutually_rated_movies[0]-1]
    ...
    for user_id in range(main.USER_PREDICTION_MIN_ID, main.USER_PREDICTION_MAX_ID):
        ...
        for user_data in main.USER_DATA_DICTIONARY[user_id]:
            ...
            if user_data[1] == 0:
                ...
                for training_data_id in range(0, 200):
                    if main.TRAINING_DATA_MATRIX[training_data_id][movie_id_of_to_be_predicted-1] != 0:
                ...
                for mutually_rated_movie_id in mutually_rated_movies:
                    mutually_rated_movie_user_cos_sim = cosine_similarity[user_id - main.USER_PREDICTION_MIN_ID][mutually_rated_movie_id - 1]
                    mutually_rated_movie_user_rating = main.TRAINING_DATA_MATRIX[mutually_rated_movie_id-1][movie_id_of_to_be_predicted-1]
                    ...
                    if len(nearest_neighbors) > main.NUM_NEAREST_NEIGHBORS:
                ...
                if denominator == 0:
                    average_rating = 0
                    number_of_ratings = 0
                    for single_user_data in main.USER_DATA_DICTIONARY[user_id]:
